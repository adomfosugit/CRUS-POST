...
const AccountProfile = ({user,btnTitle}: Props) => {
  ...
  const { startUpload } = useUploadThing("media")
    ...
    const onSubmit = async (values: z.infer<typeof userValidation>) => {
      ...
      const promise = databases.createDocument('6531ae9269b930cf1b6f', '6531aea7438566ac3a5a', 
      user.id, {
          id: user.id,
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <Image src= '/assets/profile.svg' alt="profile_photo" width={96} height={96}  priority className=' object-contain'/>}</FormLabel>
